...
from utils.load_data_rotate import  load_quadrangle_gt_roidb
...
def train_net(args, ctx, pretrained, epoch, prefix, begin_epoch, end_epoch, lr, lr_step):
    ...
    # sym generally means the network
    ...
    roidbs = [load_quadrangle_gt_roidb(config.dataset.dataset, image_set, config.dataset.root_path, config.dataset.dataset_path,
    ...
    # fyk: set max gt_boxes num to large enough for better memory sharing.
    max_data_shape.append(('gt_boxes', (config.TRAIN.BATCH_IMAGES, 1000, 9)))
    ...
    for child_metric in [rpn_eval_metric, rpn_bbox_metric, eval_metric, bbox_metric]:
