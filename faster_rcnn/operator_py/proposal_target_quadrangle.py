# --------------------------------------------------------
# normal bbox proposal, there need convert from bbox to axis aligned quadrangle, for that GT is quadrangle
...
from core.rcnn_quadrangle import sample_rois_quadrangle
