...
class resnet_v1_101_r2cnn_v2(Symbol):
    def __init__(self):
        """
    ...
    def get_symbol_simple(self, cfg, is_train=True):
        ...
        group = mx.sym.Group([rpn_cls_prob, rpn_bbox_loss, mx.sym.BlockGrad(gt_boxes), mx.sym.BlockGrad(im_info)])
        self.sym = group
        return group
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            rois, label, bbox_target, bbox_weight, bbox_rois_for_pool, bbox_target_h, bbox_weight_h = \
                mx.sym.Custom(rois=rois, gt_boxes=gt_boxes_reshape,
