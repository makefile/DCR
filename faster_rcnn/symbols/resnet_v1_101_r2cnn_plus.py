...
class resnet_v1_101_r2cnn_plus(Symbol):
    def __init__(self):
        """
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        expected_feat_stride = cfg.TRAIN.expected_feat_stride
        ...
        # clip size to c3_incept, since we do image align to 2^n, there is no need any more
        # P4_clip = mx.symbol.Crop(*[c4_upsample, c3_incept], name="P4_clip")

        # feature fusion of inception
        f3_plus = mx.sym.ElementWiseSum(*[c3_incept, c4_upsample], name='IF_c3+c4')
        ...
        # the first set are background probabilities
        ...
        roi_pool = mx.symbol.ROIPooling(
            name='roi_pool', data=conv_new_1_relu, rois=rois, pooled_size=(7, 7), spatial_scale=1. / expected_feat_stride)
        ...
        if is_train:
            ...
            group = mx.sym.Group([rpn_cls_prob, rpn_bbox_loss, cls_prob, bbox_loss, mx.sym.BlockGrad(rcnn_label),
                                  binary_mask_loss, cls_prob_h, bbox_loss_h, mx.sym.BlockGrad(rcnn_label_h)])
        else:
