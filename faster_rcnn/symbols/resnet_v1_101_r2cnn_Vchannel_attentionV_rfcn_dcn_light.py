...
class resnet_v1_101_r2cnn_Vchannel_attentionV_rfcn_dcn_light(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        stage4channels = 1024
        channel_sigmoid = self.squeeze_excitation_block(name='se', data=conv_feat, num_filter=stage4channels, ratio=1. / 16)
        # apply channel attention
        conv_feat = mx.symbol.broadcast_mul(conv_feat,
                                        mx.symbol.reshape(data=channel_sigmoid, shape=(-1, stage4channels, 1, 1)))
        # res5
