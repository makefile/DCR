...
class resnet_v1_101_rcnn_dcn_trident(Symbol):
    def __init__(self):
        """
        ...
        self.shared_param_init_zeros = [
            # dcn offset, init with 0
            'res5a_branch2b_offset', 'res5b_branch2b_offset', 'res5c_branch2b_offset', 'offset',
        ]
        self.shared_param_list = self.shared_pretrained_params + self.shared_param_init_list + self.shared_param_init_zeros
    ...
    def get_resnet_v1_conv5(self, conv_feat, prefix=''):
        ...
        res5a_branch2b_offset = mx.symbol.Convolution(name=prefix + 'res5a_branch2b_offset', data=res5a_branch2a_relu,
                                                      num_filter=72, pad=(2, 2), kernel=(3, 3), stride=(1, 1),
                                                      dilate=(2, 2), cudnn_off=True,
                                                      weight=self.shared_param_dict['res5a_branch2b_offset_weight'],
                                                      bias=self.shared_param_dict['res5a_branch2b_offset_bias'])
        res5a_branch2b = mx.contrib.symbol.DeformableConvolution(name=prefix + 'res5a_branch2b', data=res5a_branch2a_relu,
        ...
        res5b_branch2b_offset = mx.symbol.Convolution(name=prefix + 'res5b_branch2b_offset', data=res5b_branch2a_relu,
                                                      num_filter=72, pad=(2, 2), kernel=(3, 3), stride=(1, 1),
                                                      dilate=(2, 2), cudnn_off=True,
                                                      weight=self.shared_param_dict['res5b_branch2b_offset_weight'],
                                                      bias=self.shared_param_dict['res5b_branch2b_offset_bias'])
        res5b_branch2b = mx.contrib.symbol.DeformableConvolution(name=prefix + 'res5b_branch2b', data=res5b_branch2a_relu,
        ...
        res5c_branch2b_offset = mx.symbol.Convolution(name=prefix + 'res5c_branch2b_offset', data=res5c_branch2a_relu,
                                                      num_filter=72, pad=(2, 2), kernel=(3, 3), stride=(1, 1),
                                                      dilate=(2, 2), cudnn_off=True,
                                                      weight=self.shared_param_dict['res5c_branch2b_offset_weight'],
                                                      bias=self.shared_param_dict['res5c_branch2b_offset_bias'])
        res5c_branch2b = mx.contrib.symbol.DeformableConvolution(name=prefix + 'res5c_branch2b', data=res5c_branch2a_relu,
    ...
    def get_branch_symbol(self, cfg, conv3_feat, im_info, gt_boxes=None, rpn_label=None,
        ...
        offset = mx.sym.FullyConnected(name='offset', data=offset_t, num_hidden=7 * 7 * 2, lr_mult=0.01,
                                       weight=self.shared_param_dict['offset_weight'], bias=self.shared_param_dict['offset_bias'])
        ...
        # 2 fc
        fc_new_1 = mx.symbol.FullyConnected(name=prefix + 'fc_new_1', data=deformable_roi_pool, num_hidden=1024,
    ...
    def init_weight(self, cfg, arg_params, aux_params):
        ...
        for name in self.shared_param_init_zeros:
