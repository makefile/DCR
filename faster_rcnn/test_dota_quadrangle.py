...
def parse_args():
    ...
    parser.add_argument('--draw', help='turn on *draw detection result to image files*', action='store_true')
...
import mxnet as mx
from function.test_rcnn_dota import test_rcnn_dota_quadrangle
