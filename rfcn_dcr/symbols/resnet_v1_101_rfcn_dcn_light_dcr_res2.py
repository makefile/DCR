...
class resnet_v1_101_rfcn_dcn_light_dcr_res2(Symbol):
    ...
    def dcr_branch(self, res2c_relu, dilate=False):
        ...
        bn3a_branch2a = mx.symbol.BatchNorm(name='dcr_bn3a_branch2a', data=res3a_branch2a, use_global_stats=True,
                                            fix_gamma=False, eps=self.eps)
        scale3a_branch2a = bn3a_branch2a
        res3a_branch2a_relu = mx.symbol.Activation(name='dcr_res3a_branch2a_relu', data=scale3a_branch2a,
                                                   act_type='relu')
        ...
        bn3a_branch2b = mx.symbol.BatchNorm(name='dcr_bn3a_branch2b', data=res3a_branch2b, use_global_stats=True,
                                            fix_gamma=False, eps=self.eps)
        scale3a_branch2b = bn3a_branch2b
        res3a_branch2b_relu = mx.symbol.Activation(name='dcr_res3a_branch2b_relu', data=scale3a_branch2b,
                                                   act_type='relu')
        ...
        res3b2_branch2a = mx.symbol.Convolution(name='dcr_res3b2_branch2a', data=res3b1_relu, num_filter=128,
                                                pad=(0, 0),
                                                kernel=(1, 1), stride=(1, 1), no_bias=True)
        ...
        res3b3_branch2a = mx.symbol.Convolution(name='dcr_res3b3_branch2a', data=res3b2_relu, num_filter=128,
                                                pad=(0, 0),
                                                kernel=(1, 1), stride=(1, 1), no_bias=True)
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            dcr_rois, dcr_label = mx.sym.Custom(
                ...
                cfg=cPickle.dumps(cfg))
        # test select top score proposals
        elif cfg.DCR.top > 0 and cfg.DCR.top < 1:
